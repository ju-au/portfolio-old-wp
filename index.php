...
<section id="top">
  <div class="topContainer">
    ...
    <p>「聞き上手・説明上手・誠実」を心がけるWeb制作エンジニアです。<br>
...
<section id="about">
  <div class="wrapper">
    <div class="container">
      ...
      <div class="introduce">
        <h3>自己紹介</h3>
        <p>こんにちは。フリーランスとしてWeb制作をしてます、上田隼也（ウエダジュンヤ）と申します。<br>
          「聞き上手・説明上手・誠実」を心がけ、あなたのビジネスのお役に立てるWebサイトの構築をいたします。<br>
          性格は特に真面目で、人の手助けをしてあげたいという気持ちが強い傾向があります。そのおかげもあって、一度ご依頼いただいた方から再度ご依頼を受けたり、サイト以外の事でもご相談を頂いたりすることが多いのが自慢です。
        </p>
        <p>資格：基本情報技術者、調理師免許、自家用操縦士（滑空機上級）、操縦教育証明、TOEIC 810点、IELTS 6.0</p>
      </div>
      <div class="history">
        <h3>経歴</h3>
...
<section id="contact">
  <div class="wrapper">
    <div class="container">
      <h2>Contact</h2>
      <form action="<?php echo home_url(); ?>/msgSent" method="post" name="query">
